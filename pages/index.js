  ...
  return (
    <Grid>
      ...
      {/*
        ...
        <Grid.Item>
          <Img src="/luck-dragon.png" alt="Always trust to luck" />
        </Grid.Item>

        <Grid.Item>
          <Img src="/abi-sparkles.png" alt="Abi wearing sparkles" />
        </Grid.Item>
        <Grid.Item>
          <Img src="/neverending-story.png" alt="The NeverEnding Story poster" />
        </Grid.Item>
